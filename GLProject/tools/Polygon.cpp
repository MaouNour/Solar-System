...
#include <vector>
	...
	void Polygon::setDrawMode(GLenum drawingMode) {
	...
	void Polygon::drawc(Shader& shader)
	{
		glBindVertexArray(this->VAO);
		glDrawArrays(drawingMode, 0, vertices.size());
	}
...
PolygonWithTexture::PolygonWithTexture(std::vector<glm::vec3> v, std::vector<glm::vec2> t, glm::vec3 c) : Polygon(){
